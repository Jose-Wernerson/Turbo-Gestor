...
export function LoginForm() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      // Aguarda um pouco para garantir que a sessão foi salva nos cookies
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-primary/5 to-background px-4">
      <div className="mb-8 text-center">
        ...
        <p className="text-muted-foreground">Gestão completa para sua oficina</p>
      </div>

      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle>Bem-vindo!</CardTitle>
          <CardDescription>Faça login para acessar sua oficina</CardDescription>
        </CardHeader>
        <CardContent>
